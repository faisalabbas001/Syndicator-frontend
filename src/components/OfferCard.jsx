      ...
      >
        ...
        <div className=" custom-gray-bg flex flex-wrap justify-evenly md:justify-between mt-4  pb-5 mb-5 md:mb-0 md:pb-7 px-5 md:px-5 ">
          ...
          {activeStep < totalSteps && (
            <button
              onClick={handleNext}
              className={`bg-[#fec949] text-black px-4 py-2 rounded-md ${activeStep === 1 ? "w-full": "w-[48%]"} `}
            >
              Next
            </button>
          )}
...
const Optimism = ()=>{
    return (
        <>
        <span className=" mr-1 bg-red-600 ps-[1px] pe-[2px] text-[12px] font-bold rounded-sm italic ">OP</span>
        </>
    )
}
  ...
  return (
    <div className="  md:p-3 rounded-lg  max-w-lg flex flex-col w-full md:w-screen ">
      ...
      <div className="flex py-4">
        <span className=" rounded-full bg-gray-700 bg-opacity-60 px-2 me-2 text-gray-400 text-sm text-center flex justify-center items-center">1 </span>{" "}
      ...
      <div className="flex py-4">
      <span className=" rounded-full bg-gray-700 bg-opacity-60 px-2 me-2 text-gray-400 text-sm text-center flex justify-center items-center">2 </span>{" "}
        <h4 className="text-white "> Select Network</h4>
      </div>
      <div className=" flex flex-wrap gap-2">
        <Network name="Ethereum" icon={<FaEthereum className=" mr-1 text-blue-600"/>} />
        <Network name="Optimism" icon={<Optimism/>} />
        <Network name="BNB Chain" icon={<FaAirbnb className="mr-1 text-yellow-400 rounded-md opacity-75 bg-yellow-700 bg-opacity-75" />} />
        <Network name="Scroll" icon={<FaScroll className=" mr-1" />} />
        <Network name="Solana" icon={<TbCurrencySolana className=" mr-1 text-purple-800" />} />
        <Network name="Mode" icon={<AiFillMediumSquare className=" mr-1 text-black bg-yellow-500 rounded" />} />{" "}
        <Network name="Linea" icon={<FcScatterPlot className=" mr-1" />} />
        <Network name="Blast" icon={<AiOutlineBold className={"mr-1 p-[1px] italic font-bold bg-black rounded text-yellow-500"} />} />{" "}
        <Network name="Manta Pacific" icon={<FcDoughnutChart className=" mr-1" />} />
        <Network name="Starknet" icon={<FaGgCircle className=" mr-1 bg-purple-800 rounded-full" />} />
        <Network name="Marlin" icon={<TbDropCircle className=" mr-1 transform rotate-6 bg-teal-700 rounded-full" />} />
        <Network name="Base" icon={<DiDocker className=" mr-1 bg-white text-blue-700 rounded-md" />} />
        <Network name="Arbitrum" icon={<BiShapePolygon className=" mr-1 bg-blue rounded-md"/>} />
      </div>
    </div>
  );
};
...
const Card2 = () => {
  ...
  <div className="flex items-start flex-col w-full sm:w-auto">
    <div className="flex items-center w-full">
      <span className="text-xs px-2 py-0.5 rounded-sm text-gray-300 font-bold" style={{ fontSize: "60%" }}>
        OFFER
      </span>
  ...
  <div className="flex items-end w-full sm:w-auto mt-2 sm:mt-0">
    <div className="relative w-full sm:w-auto">
      ...
      <div style={{ boxShadow: "0 0px 1px 0 rgba(255, 255, 255, 0.0001), 0 1px 3px 0 rgba(255, 255, 255, 0.1)"}} className="flex flex-wrap p-2 sm:p-4 bg-[#15161b] rounded-md justify-between mt-[6px] mb-2">
  <div className="flex items-start flex-col w-full sm:w-auto">
    <div className="flex items-center w-full">
      <span
...
const Card3 = () => {
  ...
  return (
    <div className=" md:p-3 rounded-lg  max-w-lg flex flex-col w-full md:w-screen overflow-hidden">
      ...
      <p style={{lineHeight: "1"}} className="my-3 mt-3 px-4 text-[1.7rem] font-semibold">
        You want to <span className=" text-[#2aca54] ">offer 10 MACH7</span> for <span className=" text-[#2aca54]">0.1234 ETH</span>
      </p>
      ...
      <div className="flex  justify-between  border-b border-gray-700 p-2 px-3">
        ...
        <div className="flex  justify-between border-b border-gray-700 p-2 px-3">
          <div className=" text-gray-500 relative">Fill Type

          <div className="absolute top-2 left-16">
              <CiCircleInfo color="white" size={12} />
            </div>
          </div>
          <div className=" flex">   <span className="border border-gray-800 rounded-full bg-opacity-30 text-xs text-gray-500  py-[2px] px-2 	font-medium	">
                PARTIAL 
              </span>
